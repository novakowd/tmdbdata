...
```{r load pkgs, results=F, collapse=T, warning=F, message=F}
library(tmdbdata)
library(dplyr)
library(tidyr)
library(forcats)
...
```{r load imdb data, results=F, warning=F}
...
```{r rated media glimpse}
rated_media %>% glimpse()
```

# Number of observations
```{r count by titleType}
...
## Rating vs Votes
```{r ratings vs votes bin count heatmap, fig.width=8}
#| fig.alt = "2D Bin Count Heatmap of number of votes versus IMDB Rating,
#|  faceted by titleType."
...
## Rating vs Runtime
```{r ratings vs runtime bin count heatmap, fig.width=8}
#| fig.alt = "2D Bin Count Heatmap of Runtime in Minutes versus IMDB Rating,
#|  faceted by titleType."
...
## Runtime
```{r distributions of runtime, message=F, fig.width=8}
#| fig.alt = "Ridgline Plot of Runtime Densities in Minutes versus titleType.
#|  colored by titleType."
...
## Release Year
```{r distributions of release year, warning=F, message=F,fig.width=8}
#| fig.alt = "Ridgline Plot of Release year Densities versus titleType,
#|  colored by titleType."
...
# TV Episodes
## Top series (by #votes)
```{r top TV Series by number of votes}
rated_media %>% 
...
## Most Episodes
```{r  top TV Series by number of episodes, warning=F, message=F}
tv_episodes %>%
...
## Episode Heatmap
```{r Episode Heatmap code, fig.width=10, fig.height=8}
...
### Heatmap
```{r episode heatmap plot}
#| fig.alt = "Episode Heatmap of selected series, colored by IMDB Rating."
episode_heatmap
```

## Top episodes:
```{r Top Ten episodes bar chart, fig.width=8}
#| fig.alt = "Top ten Episodes of selected series, colored by IMDB Rating."
...
## Season Ratings:
```{r Average episode Ratings per season bar chart}
#| fig.alt = "Average rating of episodes per seasons for the selected series, 
#|  colored by average episode IMDB Rating."
